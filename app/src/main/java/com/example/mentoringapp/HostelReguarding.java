...
public class HostelReguarding extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDb = new DatabaseHelperhostel(this);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (subjects.trim().isEmpty() || descs.trim().isEmpty()) {
                    ...
                    Toast.makeText(HostelReguarding.this, "Please fill all fields", Toast.LENGTH_SHORT).show();
                } else {
                    boolean isInserted = myDb.insertData(subjects, descs);
                    if (isInserted) {
                        Toast.makeText(HostelReguarding.this, "Data inserted successfully", Toast.LENGTH_SHORT).show();
                        clearInputFields(); // Clear input fields after successful insertion
                    } else {
                        Toast.makeText(HostelReguarding.this, "Failed to insert data", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
