        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (subjects.trim().isEmpty() || descs.trim().isEmpty()) {
                    ...
                    Toast.makeText(ERPReguarding.this, "Please fill all fields", Toast.LENGTH_SHORT).show();
                } else {
                    boolean isInserted = myDb.insertData(subjects, descs);
                    if (isInserted) {
                        Toast.makeText(ERPReguarding.this, "Data inserted successfully", Toast.LENGTH_SHORT).show();
                        clearInputFields(); // Clear input fields after successful insertion
                    } else {
                        Toast.makeText(ERPReguarding.this, "Failed to insert data", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
